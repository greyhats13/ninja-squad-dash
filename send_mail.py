...
def kirimemail(penerima, token, fullname):
    ...
    message["Subject"] = "Permintaan Pergantian Kata Sandi SquaDash"
    ...
    html = """\
        <html>
          ...
          <body class="">
            <span class="preheader">Hai, """+fullname+""". Anda telah meminta pergantian kata sandi. Silakan ikuti instruksi yang ada dalam email ini.</span>
                          ...
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>
                                ...
                                <p>Apabila tombol tidak berfungsi, silakan salin kode di bawah ini kemudian masukkan ke laman yang telah disediakan, atau <a href="dash.ninjasquad.id/get-token">klik di sini</a>.</p>
                                <p style="border:3px dashed;font-size:17px;font-weight:bold;text-align:center">"""+token+"""</p>
                                <p>Jangan bagikan token ini kepada siapapun, dan harap untuk mengabaikan pesan ini apabila Anda tidak merasa meminta pergantian kata sandi baru-baru ini.</p><br>
                                <p>Terima kasih.</p>
